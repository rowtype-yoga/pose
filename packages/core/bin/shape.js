...
(function($PS) {
      ...
      return function ($18) {
          return (function (v) {
              if (v instanceof PureScript_CST.ParseSucceeded) {
                  return Data_Either.Right.create(Format.format(settings)(v.value0));
              };
              ...
              throw new Error("Failed pattern match at Main (line 50, column 9 - line 60, column 30): " + [ v.constructor.name ]);
  ...
  var parseAndFormatOrThrow = function (settings) {
      ...
      return function ($20) {
          return (function (v) {
              ...
              throw new Error("Failed pattern match at Main (line 40, column 9 - line 42, column 41): " + [ v.constructor.name ]);
          })($19($20));
      };
  };
  var parseAndFormat = function (settings) {
      var $21 = Data_Either.either(Control_Category.identity(Control_Category.categoryFn))(Control_Category.identity(Control_Category.categoryFn));
  ...
  var main = Effect_Aff.launchAff_(Control_Bind.bind(Effect_Aff.bindAff)(Node_FS_Aff.readTextFile(Node_Encoding.UTF8.value)($foreign.stdinFile))(function (stdinContent) {
      var $15 = stdinContent !== "";
      if ($15) {
          return parseAndFormatOrThrow(Settings.defaultSettings)(stdinContent);
      };
      var v = Data_Array.drop(2)($foreign.argv);
      if (v.length === 1) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Node_FS_Aff.readTextFile(Node_Encoding.UTF8.value)(v[0]))(parseAndFormatOrThrow(Settings.defaultSettings));
      };
