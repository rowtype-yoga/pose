...
(function($PS) {
  ...
  var space = " ";
  var singleOrMultilineFromRange = function (dictEq) {
      return function (v) {
          var $110 = Data_Eq.eq(dictEq)(v.start.line)(v.end.line);
          if ($110) {
      ...
      return function (dictRangeOf1) {
          return function (a) {
              return function (b) {
                  ...
                  return singleOrMultilineFromRange(Data_Eq.eqInt)({
                      start: v.start,
                      end: v1.end
                  });
              };
  ...
  var singleOrMultiline = function (dictRangeOf) {
      return function (value) {
          return singleOrMultilineFromRange(Data_Eq.eqInt)(PureScript_CST_Range.rangeOf(dictRangeOf)(value));
      };
  };
  ...
  var rangeOfPatternGuard = function (v) {
      var v1 = Data_Maybe.maybe(PureScript_CST_Range.rangeOf(PureScript_CST_Range.rangeOfExpr(PureScript_CST_Range.rangeOfVoid))(v.expr))((function () {
          var $906 = PureScript_CST_Range.rangeOf(PureScript_CST_Range.rangeOfBinder(PureScript_CST_Range.rangeOfVoid));
          return function ($907) {
              return $906(Data_Tuple.fst($907));
          };
      })())(v.binder);
  ...
  var rangeOfInstanceHead = function (v) {
      var v1 = (function () {
          ...
          throw new Error("Failed pattern match at Format (line 34, column 11 - line 36, column 34): " + [ v2.constructor.name ]);
      })();
      return singleOrMultilineFromRange(Data_Eq.eqInt)({
          start: v.keyword.range.start,
          end: v1.end
  ...
  var formatComment = function (v) {
      ...
      throw new Error("Failed pattern match at Format (line 1782, column 17 - line 1785, column 26): " + [ v.constructor.name ]);
  };
  var blank = "";
  var formatCommentLeading = function (indent) {
      return function (prefix) {
          return function (v) {
              ...
              throw new Error("Failed pattern match at Format (line 1739, column 38 - line 1743, column 23): " + [ v.constructor.name ]);
          };
      };
  };
  var formatCommentTrailing = function (prefix) {
      return function (comment$prime$prime) {
          ...
          throw new Error("Failed pattern match at Format (line 1749, column 42 - line 1752, column 23): " + [ comment$prime$prime.constructor.name ]);
      };
  };
  ...
  var formatSourceToken = function (indent) {
      return function (prefix) {
          return function (v) {
              return formatCommentsLeading(indent)(prefix)(v.leadingComments) + (prefix + (PureScript_CST_Print.printToken(v.value) + formatCommentsTrailing(prefix)(v.trailingComments)));
          };
      };
  };
              ...
              return function (indent$prime) {
                  return function (formatLabel) {
                      return function (formatValue) {
                          return function (v) {
                              var v1 = (function () {
                                  var v2 = singleOrMultiline(PureScript_CST_Range.rangeOfLabeled(dictRangeOf)(dictRangeOf1))(v);
                                  if (v2 instanceof MultipleLines) {
                                      return {
                                          indent: indent$prime + indentation,
                                          prefix: newline + (indent$prime + indentation)
                                      };
                                  };
                                  ...
                                  throw new Error("Failed pattern match at Format (line 1611, column 24 - line 1616, column 52): " + [ v2.constructor.name ]);
                              })();
                              return formatLabel(v.label) + (formatSourceToken(v1.indent)(space)(v.separator) + (v1.prefix + formatValue(v1.indent)(v.value)));
                          };
                      };
                  };
              };
  ...
  var formatName = function (indent) {
      return function (prefix) {
          return function (v) {
              return formatSourceToken(indent)(prefix)(v.token);
          };
      };
  };
  var formatClassFundep = function (indent) {
      return function (v) {
          if (v instanceof PureScript_CST_Types.FundepDetermined) {
              return formatSourceToken(indent)(blank)(v.value0) + Data_Foldable.foldMap(Data_Array_NonEmpty_Internal.foldableNonEmptyArray)(Data_Monoid.monoidString)(formatName(indent)(space))(v.value1);
          };
          if (v instanceof PureScript_CST_Types.FundepDetermines) {
              return Data_Foldable.foldMap(Data_Array_NonEmpty_Internal.foldableNonEmptyArray)(Data_Monoid.monoidString)(function (name) {
                  return formatName(indent)(blank)(name) + space;
              })(v.value0) + (formatSourceToken(indent)(blank)(v.value1) + Data_Foldable.foldMap(Data_Array_NonEmpty_Internal.foldableNonEmptyArray)(Data_Monoid.monoidString)(formatName(indent)(space))(v.value2));
          };
          throw new Error("Failed pattern match at Format (line 1392, column 28 - line 1399, column 53): " + [ v.constructor.name ]);
      };
  };
  var formatQualifiedName = function (indent) {
      return function (prefix) {
          return function (v) {
              return formatSourceToken(indent)(prefix)(v.token);
          };
  ...
  var formatRole = function (indentation) {
      return function (indent) {
          return function (v) {
              return formatSourceToken(indentation)(indent)(v.value0);
          };
      };
  };
  var formatCommentsTrailingModule = function (commentsTrailing$prime) {
      ...
      throw new Error("Failed pattern match at Format (line 1776, column 3 - line 1779, column 67): " + [ v.constructor.name ]);
  };
  var formatFixityOp = function (indent) {
      return function (fixityOp$prime) {
          if (fixityOp$prime instanceof PureScript_CST_Types.FixityType) {
              return formatSourceToken(indent)(blank)(fixityOp$prime.value0) + (formatQualifiedName(indent)(space)(fixityOp$prime.value1) + (formatSourceToken(indent)(space)(fixityOp$prime.value2) + formatName(indent)(space)(fixityOp$prime.value3)));
          };
          if (fixityOp$prime instanceof PureScript_CST_Types.FixityValue) {
              return formatQualifiedName(indent)(blank)(fixityOp$prime.value0) + (formatSourceToken(indent)(space)(fixityOp$prime.value1) + formatName(indent)(space)(fixityOp$prime.value2));
          };
          throw new Error("Failed pattern match at Format (line 458, column 35 - line 467, column 36): " + [ fixityOp$prime.constructor.name ]);
      };
  };
  var formatFixityFields = function (indent) {
      return function (v) {
          return formatSourceToken(indent)(blank)(v.keyword.value0) + (formatSourceToken(indent)(space)(v.prec.value0) + (space + formatFixityOp(indent)(v.operator)));
      };
  };
              ...
              return function (f) {
                  return function (recordLabeled$prime) {
                      if (recordLabeled$prime instanceof PureScript_CST_Types.RecordPun) {
                          return formatName(indent$prime)(blank)(recordLabeled$prime.value0);
                      };
                      if (recordLabeled$prime instanceof PureScript_CST_Types.RecordField) {
                          var v = (function () {
                              var v1 = singleOrMultilineBetween(PureScript_CST_Range.rangeOfName)(dictRangeOf)(recordLabeled$prime.value0)(recordLabeled$prime.value2);
                              if (v1 instanceof MultipleLines) {
                                  return new Data_Tuple.Tuple(indent$prime + (indentation + indentation), newline + (indent$prime + (indentation + indentation)));
                              };
                              if (v1 instanceof SingleLine) {
                                  return new Data_Tuple.Tuple(indent$prime, space);
                              };
                              throw new Error("Failed pattern match at Format (line 1077, column 28 - line 1081, column 29): " + [ v1.constructor.name ]);
                          })();
                          return formatName(indent$prime)(blank)(recordLabeled$prime.value0) + (formatSourceToken(indent$prime)(blank)(recordLabeled$prime.value1) + (v.value1 + f(v.value0)(recordLabeled$prime.value2)));
                      };
                      throw new Error("Failed pattern match at Format (line 1072, column 60 - line 1085, column 20): " + [ recordLabeled$prime.constructor.name ]);
                  };
              };
          };
      };
  };
  var formatSeparated = function (lines) {
      return function (indent) {
              ...
              return function (formatValue) {
                  return function (v) {
                      var prefix = (function () {
                          ...
                          throw new Error("Failed pattern match at Format (line 1706, column 14 - line 1708, column 26): " + [ lines.constructor.name ]);
                      })();
                      var go = function (v1) {
                          return prefix + (formatSourceToken(indent)(blank)(v1.value0) + (prefix$prime + formatValue(v1.value1)));
                      };
  ...
  var formatWrapped = function (indent) {
      return function (formatValue) {
          return function (v) {
              var v1 = (function () {
                  ...
                  throw new Error("Failed pattern match at Format (line 1800, column 23 - line 1802, column 50): " + [ v2.constructor.name ]);
              })();
              return formatSourceToken(indent)(blank)(v.open) + (v1.before + (formatValue(v.value) + (v1.after + formatSourceToken(indent)(blank)(v.close))));
          };
      };
  };
          ...
          return function (indent) {
              return function (formatValue) {
                  var v = (function () {
                      ...
                      throw new Error("Failed pattern match at Format (line 1302, column 23 - line 1304, column 35): " + [ lines.constructor.name ]);
                  })();
                  var formatOne = function (v1) {
                      return v.value0 + (formatSeparated(singleOrMultiline(PureScript_CST_Range.rangeOfSeparated(dictRangeOf))(v1))(indent)(space)(formatValue)(v1) + v.value1);
                  };
                  return formatWrapped(indent)(formatOne);
              };
          };
      };
  };
              ...
              return function (formatValue) {
                  return function (v) {
                      if (v.value instanceof Data_Maybe.Nothing) {
                          return formatSourceToken(indent)(blank)(v.open) + formatSourceToken(indent)(blank)(v.close);
                      };
                      if (v.value instanceof Data_Maybe.Just) {
                          return formatArrayNonEmpty(dictRangeOf)(lines)(indent)(formatValue)({
                              open: v.open,
                              value: v.value.value0,
                              close: v.close
                          });
                      };
                      throw new Error("Failed pattern match at Format (line 1279, column 40 - line 1289, column 49): " + [ v.constructor.name ]);
                  };
              };
          };
      };
  };
  var formatDelimited = function (indent) {
      return function (formatValue) {
          return function (delimited) {
              var lines = singleOrMultiline(PureScript_CST_Range.rangeOfWrapped)(delimited);
              return formatWrapped(indent)(Data_Foldable.foldMap(Data_Foldable.foldableMaybe)(Data_Monoid.monoidString)(formatSeparated(lines)(indent)(space)(formatValue)))(delimited);
          };
      };
  };
  var formatDataMembers = function (indentation) {
      return function (indent$prime) {
          return function (dataMembers$prime) {
              ...
              if (dataMembers$prime instanceof PureScript_CST_Types.DataAll) {
                  return formatSourceToken(indent$prime)(blank)(dataMembers$prime.value0);
              };
              if (dataMembers$prime instanceof PureScript_CST_Types.DataEnumerated) {
                  var v = (function () {
                      if (span instanceof MultipleLines) {
                          return new Data_Tuple.Tuple(indent$prime + indentation, newline + indent$prime);
                      };
                      if (span instanceof SingleLine) {
                          return new Data_Tuple.Tuple(indent$prime, blank);
                      };
                      throw new Error("Failed pattern match at Format (line 252, column 30 - line 256, column 31): " + [ span.constructor.name ]);
                  })();
                  return v.value1 + formatDelimited(indent$prime)(formatName(v.value0)(blank))(dataMembers$prime.value0);
              };
              throw new Error("Failed pattern match at Format (line 248, column 54 - line 261, column 19): " + [ dataMembers$prime.constructor.name ]);
          };
      };
  };
  var formatExport = function (indentation) {
      return function (indent$prime) {
          return function (export$prime) {
              ...
              if (export$prime instanceof PureScript_CST_Types.ExportClass) {
                  return formatSourceToken(indent$prime)(blank)(export$prime.value0) + formatName(indent$prime)(space)(export$prime.value1);
              };
              ...
              if (export$prime instanceof PureScript_CST_Types.ExportOp) {
                  return formatName(indent$prime)(blank)(export$prime.value0);
              };
              if (export$prime instanceof PureScript_CST_Types.ExportType) {
                  var indentTrick = indent$prime + indentation;
                  var v = (function () {
                      if (lines instanceof MultipleLines) {
                      ...
                      throw new Error("Failed pattern match at Format (line 118, column 26 - line 122, column 29): " + [ lines.constructor.name ]);
                  })();
                  return formatName(indent$prime)(blank)(export$prime.value0) + (v.value1 + Data_Foldable.foldMap(Data_Foldable.foldableMaybe)(Data_Monoid.monoidString)(formatDataMembers(indentation)(v.value0))(export$prime.value1));
              };
              ...
              throw new Error("Failed pattern match at Format (line 103, column 44 - line 131, column 32): " + [ export$prime.constructor.name ]);
          };
      };
  };
  var formatImport = function (indentation) {
      return function (indent$prime) {
          return function (import$prime$prime) {
              ...
              if (import$prime$prime instanceof PureScript_CST_Types.ImportClass) {
                  return formatSourceToken(indent$prime)(blank)(import$prime$prime.value0) + formatName(indent$prime)(space)(import$prime$prime.value1);
              };
              ...
              if (import$prime$prime instanceof PureScript_CST_Types.ImportOp) {
                  return formatName(indent$prime)(blank)(import$prime$prime.value0);
              };
              if (import$prime$prime instanceof PureScript_CST_Types.ImportType) {
                  var indent = (function () {
                      if (lines instanceof MultipleLines) {
                          return indent$prime + indentation;
                      };
                      if (lines instanceof SingleLine) {
                          return indent$prime;
                      };
                      throw new Error("Failed pattern match at Format (line 227, column 18 - line 231, column 20): " + [ lines.constructor.name ]);
                  })();
                  return formatName(indent$prime)(blank)(import$prime$prime.value0) + Data_Foldable.foldMap(Data_Foldable.foldableMaybe)(Data_Monoid.monoidString)(formatDataMembers(indentation)(indent))(import$prime$prime.value1);
              };
              ...
              throw new Error("Failed pattern match at Format (line 217, column 45 - line 239, column 32): " + [ import$prime$prime.constructor.name ]);
          };
      };
  };
  var formatDelimitedNonEmpty = function (dictRangeOf) {
      return function (lines) {
          return function (indent) {
              return function (formatValue) {
                  return formatWrapped(indent)(formatSeparated(lines)(indent)(space)(formatValue));
              };
          };
      };
  };
  var formatExports = function (indentation) {
      return function (exports$prime$prime) {
          ...
          if (exports$prime$prime instanceof Data_Maybe.Just) {
              ...
              var prefix = (function () {
                  ...
                  throw new Error("Failed pattern match at Format (line 86, column 18 - line 88, column 30): " + [ lines.constructor.name ]);
              })();
              return prefix + formatDelimitedNonEmpty(PureScript_CST_Range.rangeOfExport(PureScript_CST_Range.rangeOfVoid))(lines)(indentation)(formatExport(indentation)(indentation))(exports$prime$prime.value0);
          };
          throw new Error("Failed pattern match at Format (line 82, column 39 - line 96, column 39): " + [ exports$prime$prime.constructor.name ]);
      };
  };
  var formatImportDeclaration = function (indentation) {
      return function (indent$prime$prime) {
          return function (importDecl$prime) {
              ...
              var indent$prime = indent$prime$prime + indentation;
              return formatSourceToken(indent$prime$prime)(blank)(importDecl$prime.keyword) + (formatName(indent$prime$prime)(space)(importDecl$prime.module) + (Data_Foldable.foldMap(Data_Foldable.foldableMaybe)(Data_Monoid.monoidString)(function (v) {
                  if (v.value0 instanceof Data_Maybe.Just) {
                      var indent = indent$prime + indentation;
                      var importPrefix = (function () {
                          ...
                          throw new Error("Failed pattern match at Format (line 171, column 36 - line 175, column 30): " + [ span.constructor.name ]);
                      })();
                      var hidingPrefix = (function () {
                          ...
                          throw new Error("Failed pattern match at Format (line 166, column 36 - line 170, column 30): " + [ span.constructor.name ]);
                      })();
                      return hidingPrefix + (formatSourceToken(indent$prime)(blank)(v.value0.value0) + (importPrefix + formatDelimitedNonEmpty(PureScript_CST_Range.rangeOfImport(PureScript_CST_Range.rangeOfVoid))(span)(indent)(formatImport(indentation)(indent$prime))(v.value1)));
                  };
                  if (v.value0 instanceof Data_Maybe.Nothing) {
                      var importPrefix = (function () {
                          if (span instanceof MultipleLines) {
                          ...
                          throw new Error("Failed pattern match at Format (line 186, column 36 - line 190, column 30): " + [ span.constructor.name ]);
                      })();
                      return importPrefix + formatDelimitedNonEmpty(PureScript_CST_Range.rangeOfImport(PureScript_CST_Range.rangeOfVoid))(span)(indent$prime)(formatImport(indentation)(indent$prime))(v.value1);
                  };
                  throw new Error("Failed pattern match at Format (line 164, column 13 - line 196, column 29): " + [ v.value0.constructor.name ]);
              })(importDecl$prime.names) + Data_Foldable.foldMap(Data_Foldable.foldableMaybe)(Data_Monoid.monoidString)(function (v) {
                  var prefix = (function () {
                      if (span instanceof MultipleLines) {
                          return newline + indent$prime;
                      };
                      ...
                      throw new Error("Failed pattern match at Format (line 201, column 26 - line 205, column 26): " + [ span.constructor.name ]);
                  })();
                  return prefix + (formatSourceToken(indent$prime)(blank)(v.value0) + formatName(indent$prime)(space)(v.value1));
              })(importDecl$prime.qualified)));
          };
      };
  };
  var formatImports = function (indentation) {
      return function (imports$prime) {
          ...
          return Data_Foldable.foldMap(Data_Foldable.foldableArray)(Data_Monoid.monoidString)(function (importDecl) {
              return newline + formatImportDeclaration(indentation)(blank)(importDecl);
          })(imports$prime) + newline;
      };
  };
  var formatModuleHeader = function (indentation) {
      return function (v) {
          return formatSourceToken(blank)(blank)(v.keyword) + (formatName(blank)(space)(v.name) + (formatExports(indentation)(v.exports) + (formatSourceToken(blank)(space)(v.where) + (newline + formatImports(indentation)(v.imports)))));
      };
  };
              ...
              return function (formatValue) {
                  return function (oneOrDelimited) {
                      ...
                      if (oneOrDelimited instanceof PureScript_CST_Types.Many) {
                          return formatDelimitedNonEmpty(dictRangeOf)(lines)(indent)(formatValue)(oneOrDelimited.value0);
                      };
                      throw new Error("Failed pattern match at Format (line 1409, column 64 - line 1412, column 71): " + [ oneOrDelimited.constructor.name ]);
                  };
              };
          };
      };
              ...
              return function (formatValue) {
                  return function (wrapped) {
                      var indented = (function () {
                          ...
                          throw new Error("Failed pattern match at Format (line 1644, column 16 - line 1646, column 27): " + [ lines.constructor.name ]);
                      })();
                      return formatWrapped(indent)(formatValue(indented))(wrapped);
                  };
              };
          };
      };
  };
  var formatRecordNonEmpty = function (indent) {
      return function (formatValue) {
          return function (record$prime) {
              ...
              var v = (function () {
                  ...
                  throw new Error("Failed pattern match at Format (line 986, column 25 - line 990, column 25): " + [ lines.constructor.name ]);
              })();
              return formatWrapped(indent)(function (separated$prime) {
                  return v.value0 + (formatSeparated(lines)(indent)(space)(formatValue)(separated$prime) + v.value1);
              })(record$prime);
          };
      };
  };
  var formatRecord = function (indent) {
      return function (formatValue) {
          return function (record$prime$prime) {
              if (record$prime$prime.value instanceof Data_Maybe.Nothing) {
                  return formatSourceToken(indent)(blank)(record$prime$prime.open) + formatSourceToken(indent)(blank)(record$prime$prime.close);
              };
              if (record$prime$prime.value instanceof Data_Maybe.Just) {
                  return formatRecordNonEmpty(indent)(formatValue)({
                      open: record$prime$prime.open,
                      value: record$prime$prime.value.value0,
                      close: record$prime$prime.close
                  });
              };
              throw new Error("Failed pattern match at Format (line 968, column 44 - line 976, column 52): " + [ record$prime$prime.constructor.name ]);
          };
      };
  };
  var formatWrappedRow = function (indentation) {
      return function (indent) {
          return function (v) {
              var lines = singleOrMultiline(PureScript_CST_Range.rangeOfWrapped)(v);
              var v1 = (function () {
                  if (v.value.labels instanceof Data_Maybe.Just && lines instanceof MultipleLines) {
                      return new Data_Tuple.Tuple(space, newline + indent);
                  };
                  if (v.value.labels instanceof Data_Maybe.Nothing && lines instanceof MultipleLines) {
                      return new Data_Tuple.Tuple(blank, newline + indent);
                  };
                  if (lines instanceof SingleLine) {
                      return new Data_Tuple.Tuple(blank, blank);
                  };
                  throw new Error("Failed pattern match at Format (line 1818, column 21 - line 1821, column 36): " + [ v.value.constructor.name, lines.constructor.name ]);
              })();
              return formatSourceToken(indent)(blank)(v.open) + (v1.value0 + (formatRow(lines)(indentation)(indent)(v.value) + (v1.value1 + formatSourceToken(indent)(blank)(v.close))));
          };
      };
  };
  var formatTypeVarBindings = function (indentation) {
      return function (indent) {
          return Data_Foldable.foldMap(Data_Foldable.foldableArray)(Data_Monoid.monoidString)(Data_Semigroup.append(Data_Semigroup.semigroupFn(Data_Semigroup.semigroupString))(Control_Applicative.pure(Control_Applicative.applicativeFn)(space))(formatTypeVarBinding(indentation)(indent)));
      };
  };
  var formatTypeVarBinding = function (indentation) {
      return function (indent) {
          return function (v) {
              if (v instanceof PureScript_CST_Types.TypeVarName) {
                  return formatName(indent)(blank)(v.value0);
              };
              if (v instanceof PureScript_CST_Types.TypeVarKinded) {
                  return formatWrapped(indent)(formatLabeledName(PureScript_CST_Range.rangeOfName)(indentation)(indent))(v.value0);
              };
              throw new Error("Failed pattern match at Format (line 1465, column 43 - line 1469, column 72): " + [ v.constructor.name ]);
          };
      };
  };
  var formatType = function (indentation) {
      return function (indent) {
          return function (lines) {
              return function (t) {
                  if (t instanceof PureScript_CST_Types.TypeApp) {
                      var typesArray = Data_Array_NonEmpty.toArray(t.value1);
                      var formatTypeWithPredecessor = function (v) {
                          var v1 = (function () {
                              var v2 = singleOrMultilineBetween(PureScript_CST_Range.rangeOfType(PureScript_CST_Range.rangeOfVoid))(PureScript_CST_Range.rangeOfType(PureScript_CST_Range.rangeOfVoid))(v.value0)(v.value1);
                              if (v2 instanceof MultipleLines) {
                                  return {
                              ...
                              throw new Error("Failed pattern match at Format (line 1488, column 34 - line 1490, column 62): " + [ v2.constructor.name ]);
                          })();
                          return v1.prefix + formatType(indentation)(v1.indented)(singleOrMultiline(PureScript_CST_Range.rangeOfType(PureScript_CST_Range.rangeOfVoid))(v.value0))(v.value0);
                      };
                      return formatType(indentation)(indent)(singleOrMultiline(PureScript_CST_Range.rangeOfType(PureScript_CST_Range.rangeOfVoid))(t.value0))(t.value0) + Data_Foldable.foldMap(Data_Foldable.foldableArray)(Data_Monoid.monoidString)(formatTypeWithPredecessor)(Data_Array.zip(typesArray)(Data_Array.cons(t.value0)(typesArray)));
                  };
                  if (t instanceof PureScript_CST_Types.TypeArrow) {
                      var prefix = (function () {
                          ...
                          throw new Error("Failed pattern match at Format (line 1499, column 16 - line 1501, column 28): " + [ lines.constructor.name ]);
                      })();
                      return formatType(indentation)(indent)(singleOrMultiline(PureScript_CST_Range.rangeOfType(PureScript_CST_Range.rangeOfVoid))(t.value0))(t.value0) + (space + (formatSourceToken(indent)(blank)(t.value1) + (prefix + formatType(indentation)(indent)(singleOrMultiline(PureScript_CST_Range.rangeOfType(PureScript_CST_Range.rangeOfVoid))(t.value2))(t.value2))));
                  };
                  if (t instanceof PureScript_CST_Types.TypeArrowName) {
                      return formatSourceToken(indent)(blank)(t.value0);
                  };
                  if (t instanceof PureScript_CST_Types.TypeVar) {
                      return formatName(indent)(blank)(t.value0);
                  };
                  if (t instanceof PureScript_CST_Types.TypeConstructor) {
                      return formatQualifiedName(indent)(blank)(t.value0);
                  };
                  ...
                  if (t instanceof PureScript_CST_Types.TypeRow) {
                      return formatWrappedRow(indentation)(indent)(t.value0);
                  };
                  ...
                  if (t instanceof PureScript_CST_Types.TypeForall) {
                      var prefix = (function () {
                          ...
                          throw new Error("Failed pattern match at Format (line 1534, column 16 - line 1536, column 28): " + [ lines.constructor.name ]);
                      })();
                      return formatSourceToken(indent)(blank)(t.value0) + (formatTypeVarBindings(indentation)(indent)(Data_Array_NonEmpty.toArray(t.value1)) + (formatSourceToken(indent)(blank)(t.value2) + (prefix + formatType(indentation)(indent)(lines)(t.value3))));
                  };
                  if (t instanceof PureScript_CST_Types.TypeKinded) {
                      var v = (function () {
                          ...
                          throw new Error("Failed pattern match at Format (line 1545, column 30 - line 1547, column 58): " + [ lines.constructor.name ]);
                      })();
                      return formatType(indentation)(indent)(lines)(t.value0) + (space + (formatSourceToken(indent)(blank)(t.value1) + (v.prefix + formatType(indentation)(v.indented)(lines)(t.value2))));
                  };
                  if (t instanceof PureScript_CST_Types.TypeOp) {
                      var formatOp = function (v) {
                          var v1 = (function () {
                              if (lines instanceof MultipleLines) {
                                  return {
                                      indented: indent + indentation,
                              ...
                              throw new Error("Failed pattern match at Format (line 1558, column 32 - line 1560, column 60): " + [ lines.constructor.name ]);
                          })();
                          return formatQualifiedName(v1.indented)(v1.prefix)(v.value0) + (v1.prefix + formatType(indentation)(v1.indented)(singleOrMultiline(PureScript_CST_Range.rangeOfType(PureScript_CST_Range.rangeOfVoid))(v.value1))(v.value1));
                      };
                      return formatType(indentation)(indent)(singleOrMultiline(PureScript_CST_Range.rangeOfType(PureScript_CST_Range.rangeOfVoid))(t.value0))(t.value0) + Data_Foldable.foldMap(Data_Array_NonEmpty_Internal.foldableNonEmptyArray)(Data_Monoid.monoidString)(formatOp)(t.value1);
                  };
                  ...
                  if (t instanceof PureScript_CST_Types.TypeConstrained) {
                      var prefix = (function () {
                          ...
                          throw new Error("Failed pattern match at Format (line 1572, column 16 - line 1574, column 28): " + [ lines.constructor.name ]);
                      })();
                      return formatType(indentation)(indent)(lines)(t.value0) + (space + (formatSourceToken(indent)(blank)(t.value1) + (prefix + formatType(indentation)(indent)(lines)(t.value2))));
                  };
                  if (t instanceof PureScript_CST_Types.TypeParens) {
                      return formatParens(lines)(indentation)(indent)(function (x) {
                          return function (wrappedType) {
                              return formatType(indentation)(x)(singleOrMultiline(PureScript_CST_Range.rangeOfType(PureScript_CST_Range.rangeOfVoid))(wrappedType))(wrappedType);
                          };
                      })(t.value0);
                  };
                  if (t instanceof PureScript_CST_Types.TypeUnaryRow) {
                      var prefix = (function () {
                          ...
                          throw new Error("Failed pattern match at Format (line 1588, column 16 - line 1590, column 28): " + [ lines.constructor.name ]);
                      })();
                      return formatSourceToken(indent)(blank)(t.value0) + (prefix + formatType(indentation)(indent)(lines)(t.value1));
                  };
                  if (t instanceof PureScript_CST_Types["TypeError"]) {
                      return Data_Void.absurd(t.value0);
                  };
                  throw new Error("Failed pattern match at Format (line 1477, column 41 - line 1592, column 30): " + [ t.constructor.name ]);
              };
          };
      };
  };
  var formatRow = function (lines) {
      return function (indentation) {
          return function (indent) {
              return function (v) {
                  if (v.labels instanceof Data_Maybe.Nothing && v.tail instanceof Data_Maybe.Nothing) {
                      return blank;
                  };
                  if (v.labels instanceof Data_Maybe.Just && v.tail instanceof Data_Maybe.Nothing) {
                      var v1 = (function () {
                          if (lines instanceof MultipleLines) {
                              return {
                                  before: blank,
                          ...
                          throw new Error("Failed pattern match at Format (line 1663, column 9 - line 1665, column 74): " + [ lines.constructor.name ]);
                      })();
                      var f = formatLabeledName(PureScript_CST_Range.rangeOfName)(indentation)(v1.indented);
                      return v1.before + (formatSeparated(lines)(indent)(space)(f)(v.labels.value0) + v1.after);
                  };
                  if (v.labels instanceof Data_Maybe.Nothing && v.tail instanceof Data_Maybe.Just) {
                      var v1 = (function () {
                          if (lines instanceof MultipleLines) {
                              return {
                          ...
                          throw new Error("Failed pattern match at Format (line 1675, column 9 - line 1677, column 56): " + [ lines.constructor.name ]);
                      })();
                      return v1.before + (formatSourceToken(indent)(blank)(v.tail.value0.value0) + (space + (formatType(indentation)(indent)(lines)(v.tail.value0.value1) + v1.after)));
                  };
                  if (v.labels instanceof Data_Maybe.Just && v.tail instanceof Data_Maybe.Just) {
                      var v1 = (function () {
                          if (lines instanceof MultipleLines) {
                              return {
                                  before: blank,
                          ...
                          throw new Error("Failed pattern match at Format (line 1688, column 9 - line 1692, column 77): " + [ lines.constructor.name ]);
                      })();
                      var f = formatLabeledName(PureScript_CST_Range.rangeOfName)(indentation)(v1.indented);
                      return v1.before + (formatSeparated(lines)(indent)(space)(f)(v.labels.value0) + (v1.prefix + (formatSourceToken(indent)(blank)(v.tail.value0.value0) + (space + (formatType(indentation)(indent)(lines)(v.tail.value0.value1) + v1.after)))));
                  };
                  throw new Error("Failed pattern match at Format (line 1654, column 65 - line 1693, column 49): " + [ v.labels.constructor.name, v.tail.constructor.name ]);
              };
          };
      };
  };
      ...
      return function (indentation) {
          return function (indent) {
              return function (labeledName) {
                  return formatLabeled(dictRangeOf)(PureScript_CST_Range.rangeOfType(PureScript_CST_Range.rangeOfVoid))(indentation)(indent)(formatName(indent)(blank))(function (x) {
                      return formatType(indentation)(x)(singleOrMultiline(PureScript_CST_Range.rangeOfLabeled(dictRangeOf)(PureScript_CST_Range.rangeOfType(PureScript_CST_Range.rangeOfVoid)))(labeledName));
                  })(labeledName);
              };
          };
      };
  };
  var formatBinder = function (indentation) {
      return function (indent$prime) {
          return function (binder) {
              ...
              if (binder instanceof PureScript_CST_Types.BinderArray) {
                  return formatArray(PureScript_CST_Range.rangeOfBinder(PureScript_CST_Range.rangeOfVoid))(lines)(indent$prime)(formatBinder(indentation)(indent$prime))(binder.value0);
              };
              if (binder instanceof PureScript_CST_Types.BinderBoolean) {
                  return formatSourceToken(indent$prime)(blank)(binder.value0);
              };
              ...
              if (binder instanceof PureScript_CST_Types.BinderConstructor) {
                  var prefix = (function () {
                      var v = singleOrMultiline(PureScript_CST_Range.rangeOfBinder(PureScript_CST_Range.rangeOfVoid))(binder);
                      if (v instanceof MultipleLines) {
                          return newline + (indent$prime + indentation);
                      };
                      if (v instanceof SingleLine) {
                          return space;
                      };
                      throw new Error("Failed pattern match at Format (line 585, column 16 - line 587, column 30): " + [ v.constructor.name ]);
                  })();
                  return formatQualifiedName(indent$prime)(blank)(binder.value0) + Data_Foldable.foldMap(Data_Foldable.foldableArray)(Data_Monoid.monoidString)(function (binder$prime) {
                      return prefix + formatBinder(indentation)(indent$prime)(binder$prime);
                  })(binder.value1);
              };
              if (binder instanceof PureScript_CST_Types.BinderNamed) {
                  return formatName(indent$prime)(blank)(binder.value0) + (formatSourceToken(indent$prime)(blank)(binder.value1) + formatBinder(indentation)(indent$prime)(binder.value2));
              };
              if (binder instanceof PureScript_CST_Types.BinderNumber) {
                  return Data_Foldable.foldMap(Data_Foldable.foldableMaybe)(Data_Monoid.monoidString)(formatSourceToken(indent$prime)(blank))(binder.value0) + formatSourceToken(indent$prime)(blank)(binder.value1);
              };
              if (binder instanceof PureScript_CST_Types.BinderOp) {
                  ...
                  var v = (function () {
                      ...
                      throw new Error("Failed pattern match at Format (line 607, column 26 - line 611, column 29): " + [ lines.constructor.name ]);
                  })();
                  var formatNamedBinder = function (v1) {
                      return formatQualifiedName(indent$prime)(v.value1)(v1.value0) + (v.value1 + formatBinder(indentation)(v.value0)(v1.value1));
                  };
                  return formatBinder(indent$prime)(v.value1)(binder.value0) + Data_Foldable.foldMap(Data_Array_NonEmpty_Internal.foldableNonEmptyArray)(Data_Monoid.monoidString)(formatNamedBinder)(binder.value1);
              };
              if (binder instanceof PureScript_CST_Types.BinderParens) {
                  return formatParens(lines)(indentation)(indent$prime)(formatBinder(indentation))(binder.value0);
              };
              if (binder instanceof PureScript_CST_Types.BinderRecord) {
                  return formatRecord(indent$prime)(formatRecordLabeled(PureScript_CST_Range.rangeOfBinder(PureScript_CST_Range.rangeOfVoid))(indentation)(indent$prime)(formatBinder(indentation)))(binder.value0);
              };
              ...
              if (binder instanceof PureScript_CST_Types.BinderTyped) {
                  ...
                  var v = (function () {
                      ...
                      throw new Error("Failed pattern match at Format (line 636, column 26 - line 640, column 29): " + [ lines.constructor.name ]);
                  })();
                  return formatBinder(indentation)(indent$prime)(binder.value0) + (formatSourceToken(indent$prime)(space)(binder.value1) + (v.value1 + formatType(indentation)(v.value0)(lines)(binder.value2)));
              };
              if (binder instanceof PureScript_CST_Types.BinderVar) {
                  return formatName(indent$prime)(blank)(binder.value0);
              };
              ...
              throw new Error("Failed pattern match at Format (line 568, column 43 - line 656, column 32): " + [ binder.constructor.name ]);
          };
      };
  };
  var formatDataConstructor = function (indentation) {
      return function (indent) {
          return function (v) {
              var lines = singleOrMultiline(PureScript_CST_Range.rangeOfDataCtor(PureScript_CST_Range.rangeOfVoid))(v);
              var v1 = (function () {
                  if (lines instanceof MultipleLines) {
                      var indented = indent + indentation;
                      return {
                          indented: indented,
                  ...
                  throw new Error("Failed pattern match at Format (line 1436, column 28 - line 1440, column 58): " + [ lines.constructor.name ]);
              })();
              var formatField = function (typo) {
                  return v1.prefix + formatType(indentation)(v1.indented)(lines)(typo);
              };
              return space + (formatName(indent)(blank)(v.name) + Data_Foldable.foldMap(Data_Foldable.foldableArray)(Data_Monoid.monoidString)(formatField)(v.fields));
          };
      };
  };
  var formatInstanceHead = function (indentation) {
      return function (indent$prime$prime) {
          return function (v) {
              var lines = rangeOfInstanceHead(v);
              var v1 = (function () {
                  if (lines instanceof MultipleLines) {
                      return new Data_Tuple.Tuple(indent$prime$prime + (indentation + indentation), new Data_Tuple.Tuple(indent$prime$prime + indentation, newline + (indent$prime$prime + indentation)));
                  };
                  if (lines instanceof SingleLine) {
                      return new Data_Tuple.Tuple(indent$prime$prime, new Data_Tuple.Tuple(indent$prime$prime, space));
                  };
                  throw new Error("Failed pattern match at Format (line 500, column 41 - line 506, column 44): " + [ lines.constructor.name ]);
              })();
              var typePrefix = (function () {
                  var v2 = Data_Array.last(v.types);
                  if (v2 instanceof Data_Maybe.Just) {
                      var v3 = singleOrMultilineBetween(PureScript_CST_Range.rangeOfQualifiedName)(PureScript_CST_Range.rangeOfType(PureScript_CST_Range.rangeOfVoid))(v.className)(v2.value0);
                      if (v3 instanceof MultipleLines) {
                          return newline + v1.value0;
                      };
                      if (v3 instanceof SingleLine) {
                          return space;
                      };
                      throw new Error("Failed pattern match at Format (line 508, column 28 - line 510, column 32): " + [ v3.constructor.name ]);
                  };
                  if (v2 instanceof Data_Maybe.Nothing) {
                      return space;
                  };
                  throw new Error("Failed pattern match at Format (line 507, column 22 - line 511, column 27): " + [ v2.constructor.name ]);
              })();
              return formatSourceToken(indent$prime$prime)(blank)(v.keyword) + (Data_Foldable.foldMap(Data_Foldable.foldableMaybe)(Data_Monoid.monoidString)(function (v2) {
                  return formatName(indent$prime$prime)(space)(v2.name) + formatSourceToken(indent$prime$prime)(space)(v2.separator);
              })(v.nameAndSeparator) + (Data_Foldable.foldMap(Data_Foldable.foldableMaybe)(Data_Monoid.monoidString)(function (v2) {
                  return v1.value1.value1 + (formatOneOrDelimited(PureScript_CST_Range.rangeOfType(PureScript_CST_Range.rangeOfVoid))(lines)(v1.value1.value0)(function (t) {
                      return formatType(indentation)(v1.value0)(singleOrMultiline(PureScript_CST_Range.rangeOfType(PureScript_CST_Range.rangeOfVoid))(t))(t);
                  })(v2.value0) + formatSourceToken(v1.value1.value0)(space)(v2.value1));
              })(v.constraints) + (formatQualifiedName(v1.value1.value0)(v1.value1.value1)(v.className) + Data_Foldable.foldMap(Data_Foldable.foldableArray)(Data_Monoid.monoidString)(function (type$prime$prime) {
                  return typePrefix + formatType(indentation)(v1.value0)(singleOrMultiline(PureScript_CST_Range.rangeOfType(PureScript_CST_Range.rangeOfVoid))(type$prime$prime))(type$prime$prime);
              })(v.types))));
          };
      };
  };
          ...
          return function (indent) {
              return function (v) {
                  var v1 = (function () {
                      ...
                      throw new Error("Failed pattern match at Format (line 1360, column 28 - line 1364, column 56): " + [ lines.constructor.name ]);
                  })();
                  var formatTypeVariableBinding = function (binding) {
                      return space + formatTypeVarBinding(indentation)(indent)(binding);
                  };
                  var formatSuper = function (v2) {
                      return v1.prefix + (formatOneOrDelimited(PureScript_CST_Range.rangeOfType(PureScript_CST_Range.rangeOfVoid))(lines)(v1.indented)(formatType(indentation)(indent)(lines))(v2.value0) + formatSourceToken(indent)(space)(v2.value1));
                  };
                  var formatFunctionalDependency = function (v2) {
                      return formatSourceToken(indent)(space)(v2.value0) + (space + formatSeparated(lines)(indent)(space)(formatClassFundep(indent))(v2.value1));
                  };
                  return formatSourceToken(v1.indented)(blank)(v.keyword) + (Data_Foldable.foldMap(Data_Foldable.foldableMaybe)(Data_Monoid.monoidString)(formatSuper)(v["super"]) + (formatName(indent)(space)(v.name) + (Data_Foldable.foldMap(Data_Foldable.foldableArray)(Data_Monoid.monoidString)(formatTypeVariableBinding)(v.vars) + Data_Foldable.foldMap(Data_Foldable.foldableMaybe)(Data_Monoid.monoidString)(formatFunctionalDependency)(v.fundeps))));
              };
          };
      };
  };
  var formatDataHead = function (indentation) {
      return function (indent) {
          return function (v) {
              return formatSourceToken(indent)(blank)(v.keyword) + (formatName(indent)(space)(v.name) + formatTypeVarBindings(indentation)(indent)(v.vars));
          };
      };
  };
  var formatLabeledNameKind = function (indentation) {
      return function (indent) {
          return function (labeled) {
              return formatLabeled(PureScript_CST_Range.rangeOfName)(PureScript_CST_Range.rangeOfType(PureScript_CST_Range.rangeOfVoid))(indentation)(indent)(formatName(indent)(blank))(function (x) {
                  return formatType(indentation)(x)(singleOrMultiline(PureScript_CST_Range.rangeOfLabeled(PureScript_CST_Range.rangeOfName)(PureScript_CST_Range.rangeOfType(PureScript_CST_Range.rangeOfVoid)))(labeled));
              })(labeled);
          };
      };
  };
  var formatLabeledNameType = function (indentation) {
      return function (indent) {
          return function (labeled) {
              return formatLabeled(PureScript_CST_Range.rangeOfName)(PureScript_CST_Range.rangeOfType(PureScript_CST_Range.rangeOfVoid))(indentation)(indent)(formatName(indent)(blank))(function (x) {
                  return formatType(indentation)(x)(singleOrMultiline(PureScript_CST_Range.rangeOfLabeled(PureScript_CST_Range.rangeOfName)(PureScript_CST_Range.rangeOfType(PureScript_CST_Range.rangeOfVoid)))(labeled));
  ...
  var formatForeign = function (span) {
      return function (indentation) {
          return function (indent$prime) {
              return function (foreign$prime$prime) {
                  if (foreign$prime$prime instanceof PureScript_CST_Types.ForeignData) {
                      return formatSourceToken(indent$prime)(blank)(foreign$prime$prime.value0) + (space + formatLabeledNameKind(indentation)(indent$prime)(foreign$prime$prime.value1));
                  };
                  if (foreign$prime$prime instanceof PureScript_CST_Types.ForeignKind) {
                      return formatSourceToken(indent$prime)(blank)(foreign$prime$prime.value0) + formatName(indent$prime)(space)(foreign$prime$prime.value1);
                  };
                  if (foreign$prime$prime instanceof PureScript_CST_Types.ForeignValue) {
                      return formatLabeledNameType(indentation)(indent$prime)(foreign$prime$prime.value0);
                  };
                  throw new Error("Failed pattern match at Format (line 417, column 52 - line 426, column 55): " + [ foreign$prime$prime.constructor.name ]);
              };
          };
      };
  };
  var formatWhere = function (indentation) {
      return function (indent$prime) {
          return function (v) {
              var indent = indent$prime + indentation;
              return formatExprPrefix(singleOrMultiline(PureScript_CST_Range.rangeOfExpr(PureScript_CST_Range.rangeOfVoid))(v.expr))(indentation)(indent$prime)(v.expr) + Data_Foldable.foldMap(Data_Foldable.foldableMaybe)(Data_Monoid.monoidString)(function (v1) {
                  return newline + indent + (formatSourceToken(indent)(blank)(v1.value0) + (Data_Foldable.foldMap(Data_Foldable.foldableArray)(Data_Monoid.monoidString)(formatLetBinding(indentation)(indent)(newline + indent)(newline))(Data_Array_NonEmpty.init(v1.value1)) + formatLetBinding(indentation)(indent)(newline + indent)(blank)(Data_Array_NonEmpty.last(v1.value1))));
              })(v.bindings);
          };
      };
  };
  var formatValueBindingFields = function (indentation) {
      return function (indent) {
          return function (v) {
              var formatValueBinder = function (binder) {
                  return space + formatBinder(indentation)(indent)(binder);
              };
              return formatName(indent)(blank)(v.name) + (Data_Foldable.foldMap(Data_Foldable.foldableArray)(Data_Monoid.monoidString)(formatValueBinder)(v.binders) + formatGuarded(indentation)(indent)(v.guarded));
          };
      };
  };
  var formatRecordUpdate = function (indentation) {
      return function (indent$prime) {
          return function (recordUpdate$prime) {
              if (recordUpdate$prime instanceof PureScript_CST_Types.RecordUpdateBranch) {
                  ...
                  var v = (function () {
                      ...
                      throw new Error("Failed pattern match at Format (line 1038, column 26 - line 1042, column 29): " + [ lines.constructor.name ]);
                  })();
                  return formatName(indent$prime)(blank)(recordUpdate$prime.value0) + (v.value1 + formatRecordNonEmpty(v.value0)(formatRecordUpdate(indentation)(v.value0))(recordUpdate$prime.value1));
              };
              if (recordUpdate$prime instanceof PureScript_CST_Types.RecordUpdateLeaf) {
                  ...
                  var v = (function () {
                      ...
                      throw new Error("Failed pattern match at Format (line 1053, column 26 - line 1057, column 29): " + [ lines.constructor.name ]);
                  })();
                  return formatName(indent$prime)(blank)(recordUpdate$prime.value0) + (formatSourceToken(indent$prime)(space)(recordUpdate$prime.value1) + (v.value1 + formatExpr(indentation)(v.value0)(recordUpdate$prime.value2)));
              };
              throw new Error("Failed pattern match at Format (line 1033, column 56 - line 1062, column 45): " + [ recordUpdate$prime.constructor.name ]);
          };
      };
  };
          ...
          return function (indent$prime) {
              return function (recordAccessor$prime) {
                  ...
                  var v = (function () {
                      ...
                      throw new Error("Failed pattern match at Format (line 1012, column 26 - line 1016, column 29): " + [ lines.constructor.name ]);
                  })();
                  return formatExpr(indentation)(v.value0)(recordAccessor$prime.expr) + (v.value1 + (formatSourceToken(v.value0)(blank)(recordAccessor$prime.dot) + formatSeparated(lines)(v.value0)(blank)(formatName(indent$prime)(blank))(recordAccessor$prime.path)));
              };
          };
      };
  };
  var formatPatternGuard = function (indentation) {
      return function (indent) {
          return function (v) {
              var lines = singleOrMultilineFromRange(Data_Eq.eqInt)(rangeOfPatternGuard(v));
              if (v.binder instanceof Data_Maybe.Just) {
                  return formatBinder(indentation)(indent)(v.binder.value0.value0) + (formatSourceToken(indent)(space)(v.binder.value0.value1) + formatExprPrefix(lines)(indentation)(indent)(v.expr));
              };
              if (v.binder instanceof Data_Maybe.Nothing) {
                  return formatExpr(indentation)(indent)(v.expr);
              };
              throw new Error("Failed pattern match at Format (line 755, column 5 - line 761, column 44): " + [ v.binder.constructor.name ]);
          };
      };
  };
      ...
      return function (indentation) {
          return function (indent$prime) {
              return function (letIn$prime) {
                  var v = (function () {
                      if (lines instanceof MultipleLines) {
                          return new Data_Tuple.Tuple(newline + indent$prime, new Data_Tuple.Tuple(indent$prime + indentation, newline + (indent$prime + indentation)));
                      };
                      if (lines instanceof SingleLine) {
                          return new Data_Tuple.Tuple(space, new Data_Tuple.Tuple(indent$prime, space));
                      };
                      throw new Error("Failed pattern match at Format (line 1100, column 38 - line 1104, column 36): " + [ lines.constructor.name ]);
                  })();
                  return formatSourceToken(indent$prime)(blank)(letIn$prime.keyword) + (Data_Foldable.foldMap(Data_Foldable.foldableArray)(Data_Monoid.monoidString)(formatLetBinding(indentation)(v.value1.value0)(v.value1.value1)(newline))(Data_Array_NonEmpty.init(letIn$prime.bindings)) + (formatLetBinding(indentation)(v.value1.value0)(v.value1.value1)(blank)(Data_Array_NonEmpty.last(letIn$prime.bindings)) + (v.value0 + (formatSourceToken(indent$prime)(blank)(letIn$prime["in"]) + (v.value1.value1 + formatExpr(indentation)(v.value1.value0)(letIn$prime.body))))));
              };
          };
      };
  };
  var formatLetBinding = function (indentation) {
      return function (indent$prime) {
          return function (prefix) {
              return function (suffix) {
                  return function (v) {
                      if (v instanceof PureScript_CST_Types.LetBindingName) {
                          return prefix + (formatValueBindingFields(indentation)(indent$prime)(v.value0) + suffix);
                      };
                      if (v instanceof PureScript_CST_Types.LetBindingPattern) {
                          return prefix + (formatBinder(indentation)(indent$prime)(v.value0) + (formatSourceToken(indent$prime)(space)(v.value1) + (formatWhere(indentation)(indent$prime)(v.value2) + suffix)));
                      };
                      if (v instanceof PureScript_CST_Types.LetBindingSignature) {
                          return prefix + formatLabeledNameType(indentation)(indent$prime)(v.value0);
                      };
                      if (v instanceof PureScript_CST_Types.LetBindingError) {
                          return Data_Void.absurd(v.value0);
                      };
                      throw new Error("Failed pattern match at Format (line 709, column 54 - line 727, column 36): " + [ v.constructor.name ]);
                  };
              };
          };
      };
      ...
      return function (indentation) {
          return function (indent$prime) {
              return function (lambda$prime) {
                  return formatSourceToken(indent$prime)(blank)(lambda$prime.symbol) + (Data_Foldable.foldMap(Data_Array_NonEmpty_Internal.foldableNonEmptyArray)(Data_Monoid.monoidString)(function (binder$prime) {
                      return formatBinder(indentation)(indent$prime)(binder$prime) + space;
                  })(lambda$prime.binders) + (formatSourceToken(indent$prime)(blank)(lambda$prime.arrow) + formatExprPrefix(lines)(indentation)(indent$prime)(lambda$prime.body)));
              };
          };
      };
  };
          ...
          return function (indent) {
              return function (v) {
                  var prefix = (function () {
                      ...
                      throw new Error("Failed pattern match at Format (line 1181, column 12 - line 1183, column 24): " + [ lines.constructor.name ]);
                  })();
                  return formatSourceToken(indent)(blank)(v.keyword) + (space + (formatExpr(indentation)(indent)(v.cond) + (space + (formatSourceToken(indent)(blank)(v.then) + (formatExprPrefix(lines)(indentation)(indent)(v["true"]) + (prefix + (formatSourceToken(indent)(blank)(v["else"]) + formatExprPrefixElseIf(lines)(indentation)(indent)(v["false"]))))))));
              };
          };
      };
  };
  var formatGuardedExpr = function (indentation) {
      return function (indent$prime) {
          return function (expr) {
              var indent = indent$prime + indentation;
              return formatSourceToken(indent$prime)(blank)(expr.bar) + (space + (formatSeparated(singleOrMultilineFromRange(Data_Eq.eqInt)(rangeOfSeparated(rangeOfPatternGuard)(expr.patterns)))(indent$prime)(space)(formatPatternGuard(indentation)(indent))(expr.patterns) + (space + (formatSourceToken(indent$prime)(blank)(expr.separator) + formatWhere(indentation)(indent$prime)(expr.where)))));
          };
      };
  };
  var formatGuarded = function (indentation) {
      return function (indent$prime) {
          return function (v) {
              if (v instanceof PureScript_CST_Types.Guarded) {
                  var indent = indent$prime + indentation;
                  return Data_Foldable.foldMap(Data_Array_NonEmpty_Internal.foldableNonEmptyArray)(Data_Monoid.monoidString)(function (guardedExpr) {
                      return newline + indent + formatGuardedExpr(indentation)(indent)(guardedExpr);
                  })(v.value0);
              };
              if (v instanceof PureScript_CST_Types.Unconditional) {
                  return formatSourceToken(indent$prime)(space)(v.value0) + formatWhere(indentation)(indent$prime)(v.value1);
              };
              throw new Error("Failed pattern match at Format (line 665, column 37 - line 676, column 52): " + [ v.constructor.name ]);
          };
      };
  };
          ...
          return function (indent) {
              return function (expr$prime) {
                  if (expr$prime instanceof PureScript_CST_Types.ExprAdo) {
                      return formatExprPrefix(lines)(indentation)(indent)(expr$prime);
                  };
                  ...
                  if (expr$prime instanceof PureScript_CST_Types.ExprIf) {
                      return space + formatExpr(indentation)(indent)(expr$prime);
                  };
                  ...
                  throw new Error("Failed pattern match at Format (line 1135, column 3 - line 1162, column 32): " + [ expr$prime.constructor.name ]);
              };
          };
      };
  };
          ...
          return function (indent$prime) {
              return function (expr) {
                  var indent = (function () {
                      ...
                      throw new Error("Failed pattern match at Format (line 769, column 12 - line 796, column 34): " + [ expr.constructor.name ]);
                  })();
                  var multiLine = (function () {
                      ...
                      throw new Error("Failed pattern match at Format (line 798, column 15 - line 825, column 34): " + [ expr.constructor.name ]);
                  })();
                  var prefix = (function () {
                      if (lines instanceof MultipleLines) {
                          return multiLine;
                      ...
                      throw new Error("Failed pattern match at Format (line 828, column 12 - line 830, column 24): " + [ lines.constructor.name ]);
                  })();
                  return prefix + formatExpr(indentation)(indent)(expr);
              };
          };
      };
  };
  var formatExpr = function (indentation) {
      return function (indent$prime$prime) {
          return function (expr$prime$prime) {
              ...
              if (expr$prime$prime instanceof PureScript_CST_Types.ExprAdo) {
                  return formatAdoBlock(lines)(indentation)(indent$prime$prime)(expr$prime$prime.value0);
              };
              if (expr$prime$prime instanceof PureScript_CST_Types.ExprApp) {
                  var formatApp = function (curr) {
                      return formatExprPrefix(singleOrMultilineBetween(PureScript_CST_Range.rangeOfExpr(PureScript_CST_Range.rangeOfVoid))(PureScript_CST_Range.rangeOfExpr(PureScript_CST_Range.rangeOfVoid))(expr$prime$prime.value0)(curr))(indentation)(indent$prime$prime)(curr);
                  };
                  return formatExpr(indentation)(indent$prime$prime)(expr$prime$prime.value0) + Data_Foldable.foldMap(Data_Array_NonEmpty_Internal.foldableNonEmptyArray)(Data_Monoid.monoidString)(formatApp)(expr$prime$prime.value1);
              };
              if (expr$prime$prime instanceof PureScript_CST_Types.ExprArray) {
                  var indent$prime = (function () {
                      if (lines instanceof MultipleLines) {
                          return indent$prime$prime + indentation;
                      };
                      if (lines instanceof SingleLine) {
                          return indent$prime$prime;
                      };
                      throw new Error("Failed pattern match at Format (line 847, column 19 - line 851, column 21): " + [ lines.constructor.name ]);
                  })();
                  return formatArray(PureScript_CST_Range.rangeOfExpr(PureScript_CST_Range.rangeOfVoid))(lines)(indent$prime$prime)(formatExpr(indentation)(indent$prime))(expr$prime$prime.value0);
              };
              if (expr$prime$prime instanceof PureScript_CST_Types.ExprBoolean) {
                  return formatSourceToken(indent$prime$prime)(blank)(expr$prime$prime.value0);
              };
              if (expr$prime$prime instanceof PureScript_CST_Types.ExprCase) {
                  return formatCaseOf(lines)(indentation)(indent$prime$prime)(expr$prime$prime.value0);
              };
              ...
              if (expr$prime$prime instanceof PureScript_CST_Types.ExprConstructor) {
                  return formatQualifiedName(indent$prime$prime)(blank)(expr$prime$prime.value0);
              };
              if (expr$prime$prime instanceof PureScript_CST_Types.ExprDo) {
                  return formatDoBlock(lines)(indentation)(indent$prime$prime)(expr$prime$prime.value0);
              };
              if (expr$prime$prime instanceof PureScript_CST_Types.ExprHole) {
                  return formatName(indent$prime$prime)(blank)(expr$prime$prime.value0);
              };
              if (expr$prime$prime instanceof PureScript_CST_Types.ExprIdent) {
                  return formatQualifiedName(indent$prime$prime)(blank)(expr$prime$prime.value0);
              };
              if (expr$prime$prime instanceof PureScript_CST_Types.ExprIf) {
                  return formatIfThenElse(lines)(indentation)(indent$prime$prime)(expr$prime$prime.value0);
              };
              if (expr$prime$prime instanceof PureScript_CST_Types.ExprInfix) {
                  var v = (function () {
                      if (lines instanceof MultipleLines) {
                          return new Data_Tuple.Tuple(indent$prime$prime + (indentation + indentation), new Data_Tuple.Tuple(indent$prime$prime + indentation, new Data_Tuple.Tuple(newline + (indent$prime$prime + indentation), newline + (indent$prime$prime + indentation + indentation))));
                      };
                      if (lines instanceof SingleLine) {
                          return new Data_Tuple.Tuple(indent$prime$prime, new Data_Tuple.Tuple(indent$prime$prime, new Data_Tuple.Tuple(space, space)));
                      };
                      throw new Error("Failed pattern match at Format (line 878, column 50 - line 886, column 51): " + [ lines.constructor.name ]);
                  })();
                  var formatOne = function (v1) {
                      return formatWrapped(v.value0)(formatExpr(indentation)(v.value1.value0))(v1.value0) + (v.value1.value1.value1 + formatExpr(indentation)(v.value0)(v1.value1));
                  };
                  return formatExpr(indentation)(indent$prime$prime)(expr$prime$prime.value0) + (v.value1.value1.value0 + Data_Foldable.foldMap(Data_Array_NonEmpty_Internal.foldableNonEmptyArray)(Data_Monoid.monoidString)(formatOne)(expr$prime$prime.value1));
              };
              if (expr$prime$prime instanceof PureScript_CST_Types.ExprLambda) {
                  return formatLambda(lines)(indentation)(indent$prime$prime)(expr$prime$prime.value0);
              };
              if (expr$prime$prime instanceof PureScript_CST_Types.ExprLet) {
                  return formatLetIn(lines)(indentation)(indent$prime$prime)(expr$prime$prime.value0);
              };
              if (expr$prime$prime instanceof PureScript_CST_Types.ExprNegate) {
                  return formatSourceToken(indent$prime$prime)(blank)(expr$prime$prime.value0) + formatExpr(indentation)(indent$prime$prime)(expr$prime$prime.value1);
              };
              ...
              if (expr$prime$prime instanceof PureScript_CST_Types.ExprOp) {
                  var v = (function () {
                      ...
                      if (lines instanceof SingleLine) {
                          return new Data_Tuple.Tuple(indent$prime$prime + indentation, new Data_Tuple.Tuple(indent$prime$prime, space));
                      };
                      throw new Error("Failed pattern match at Format (line 902, column 37 - line 906, column 59): " + [ lines.constructor.name ]);
                  })();
                  return formatExpr(indentation)(indent$prime$prime)(expr$prime$prime.value0) + Data_Foldable.foldMap(Data_Array_NonEmpty_Internal.foldableNonEmptyArray)(Data_Monoid.monoidString)(function (v1) {
                      return formatQualifiedName(v.value1.value0)(v.value1.value1)(v1.value0) + (space + formatExpr(indentation)(v.value0)(v1.value1));
              ...
              if (expr$prime$prime instanceof PureScript_CST_Types.ExprParens) {
                  return formatParens(lines)(indentation)(indent$prime$prime)(formatExpr(indentation))(expr$prime$prime.value0);
              };
              if (expr$prime$prime instanceof PureScript_CST_Types.ExprRecord) {
                  return formatRecord(indent$prime$prime)(formatRecordLabeled(PureScript_CST_Range.rangeOfExpr(PureScript_CST_Range.rangeOfVoid))(indentation)(indent$prime$prime)(formatExpr(indentation)))(expr$prime$prime.value0);
              };
              if (expr$prime$prime instanceof PureScript_CST_Types.ExprRecordAccessor) {
                  return formatRecordAccessor(lines)(indentation)(indent$prime$prime)(expr$prime$prime.value0);
              };
              if (expr$prime$prime instanceof PureScript_CST_Types.ExprRecordUpdate) {
                  var v = (function () {
                      if (lines instanceof MultipleLines) {
                          return new Data_Tuple.Tuple(indent$prime$prime + indentation, newline + (indent$prime$prime + indentation));
                      };
                      if (lines instanceof SingleLine) {
                          return new Data_Tuple.Tuple(indent$prime$prime, space);
                      };
                      throw new Error("Failed pattern match at Format (line 931, column 27 - line 935, column 30): " + [ lines.constructor.name ]);
                  })();
                  return formatExpr(indentation)(indent$prime$prime)(expr$prime$prime.value0) + (v.value1 + formatRecordNonEmpty(v.value0)(formatRecordUpdate(indentation)(v.value0))(expr$prime$prime.value1));
              };
              ...
              if (expr$prime$prime instanceof PureScript_CST_Types.ExprTyped) {
                  var v = (function () {
                      ...
                      throw new Error("Failed pattern match at Format (line 948, column 27 - line 952, column 30): " + [ lines.constructor.name ]);
                  })();
                  return formatExpr(indentation)(indent$prime$prime)(expr$prime$prime.value0) + (formatSourceToken(indent$prime$prime)(space)(expr$prime$prime.value1) + (v.value1 + formatType(indentation)(v.value0)(lines)(expr$prime$prime.value2)));
              };
              ...
              throw new Error("Failed pattern match at Format (line 837, column 42 - line 958, column 30): " + [ expr$prime$prime.constructor.name ]);
          };
      };
  };
  var formatDoStatement = function (indentation) {
      return function (indent$prime) {
          return function (doStatement$prime) {
              if (doStatement$prime instanceof PureScript_CST_Types.DoBind) {
                  return formatBinder(indentation)(indent$prime)(doStatement$prime.value0) + (formatSourceToken(indent$prime)(space)(doStatement$prime.value1) + formatExprPrefix(singleOrMultiline(PureScript_CST_Range.rangeOfDoStatement(PureScript_CST_Range.rangeOfVoid))(doStatement$prime))(indentation)(indent$prime)(doStatement$prime.value2));
              };
              if (doStatement$prime instanceof PureScript_CST_Types.DoDiscard) {
                  return formatExpr(indentation)(indent$prime)(doStatement$prime.value0);
              };
              if (doStatement$prime instanceof PureScript_CST_Types.DoLet) {
                  var indent = indent$prime + indentation;
                  return formatSourceToken(indent$prime)(blank)(doStatement$prime.value0) + (Data_Foldable.foldMap(Data_Foldable.foldableArray)(Data_Monoid.monoidString)(formatLetBinding(indentation)(indent)(newline + indent)(newline))(Data_Array_NonEmpty.init(doStatement$prime.value1)) + formatLetBinding(indentation)(indent)(newline + indent)(blank)(Data_Array_NonEmpty.last(doStatement$prime.value1)));
              };
              if (doStatement$prime instanceof PureScript_CST_Types.DoError) {
                  return Data_Void.absurd(doStatement$prime.value0);
              };
              throw new Error("Failed pattern match at Format (line 1214, column 54 - line 1233, column 28): " + [ doStatement$prime.constructor.name ]);
          };
      };
  };
          ...
          return function (indent$prime) {
              return function (doBlock$prime) {
                  ...
                  var v = (function () {
                      ...
                      throw new Error("Failed pattern match at Format (line 1196, column 26 - line 1200, column 29): " + [ lines.constructor.name ]);
                  })();
                  return formatSourceToken(indent$prime)(blank)(doBlock$prime.keyword) + Data_Foldable.foldMap(Data_Array_NonEmpty_Internal.foldableNonEmptyArray)(Data_Monoid.monoidString)(function (doStatement$prime) {
                      return v.value1 + formatDoStatement(indentation)(v.value0)(doStatement$prime);
      ...
      return function (indentation) {
          return function (indent$prime) {
              return function (caseOf$prime) {
                  var v = (function () {
                      if (lines instanceof MultipleLines) {
                          return new Data_Tuple.Tuple(indent$prime + indentation, newline + (indent$prime + indentation));
                      };
                      if (lines instanceof SingleLine) {
                          return new Data_Tuple.Tuple(indent$prime, space);
                      };
                      throw new Error("Failed pattern match at Format (line 1244, column 26 - line 1246, column 39): " + [ lines.constructor.name ]);
                  })();
                  return formatSourceToken(indent$prime)(blank)(caseOf$prime.keyword) + (space + (formatSeparated(singleOrMultiline(PureScript_CST_Range.rangeOfSeparated(PureScript_CST_Range.rangeOfExpr(PureScript_CST_Range.rangeOfVoid)))(caseOf$prime.head))(v.value0)(space)(formatExpr(indentation)(v.value0))(caseOf$prime.head) + (space + (formatSourceToken(indent$prime)(blank)(caseOf$prime.of) + Data_Foldable.foldMap(Data_Array_NonEmpty_Internal.foldableNonEmptyArray)(Data_Monoid.monoidString)(function (v1) {
                      return v.value1 + (formatSeparated(singleOrMultiline(PureScript_CST_Range.rangeOfSeparated(PureScript_CST_Range.rangeOfBinder(PureScript_CST_Range.rangeOfVoid)))(v1.value0))(v.value0)(space)(formatBinder(indentation)(v.value0))(v1.value0) + formatGuarded(indentation)(v.value0)(v1.value1));
          ...
          return function (indent$prime) {
              return function (v) {
                  var v1 = (function () {
                      ...
                      throw new Error("Failed pattern match at Format (line 1318, column 28 - line 1322, column 57): " + [ lines.constructor.name ]);
                  })();
                  return formatSourceToken(indent$prime)(blank)(v.keyword) + (Data_Foldable.foldMap(Data_Foldable.foldableArray)(Data_Monoid.monoidString)(function (doStatement$prime) {
                      return v1.prefix + formatDoStatement(indentation)(v1.indent)(doStatement$prime);
                  })(v.statements) + (v1.prefix + (formatSourceToken(indent$prime)(blank)(v["in"]) + (space + formatExpr(indentation)(v1.indent)(v.result)))));
              };
          };
      };
  };
  var formatInstanceBinding = function (indentation) {
      return function (indent) {
          return function (v) {
              if (v instanceof PureScript_CST_Types.InstanceBindingSignature) {
                  return formatLabeledNameType(indentation)(indent)(v.value0);
              };
              if (v instanceof PureScript_CST_Types.InstanceBindingName) {
                  return formatValueBindingFields(indentation)(indent)(v.value0);
              };
              throw new Error("Failed pattern match at Format (line 538, column 44 - line 542, column 67): " + [ v.constructor.name ]);
          };
      };
  };
  var formatInstance = function (indentation) {
      return function (indent) {
          return function (v) {
              var indented = indent + indentation;
              var formatBinding = function (instanceBinding) {
                  return newline + (indented + formatInstanceBinding(indentation)(indented)(instanceBinding));
              };
              var formatBindings = function (v1) {
                  return formatSourceToken(indent)(space)(v1.value0) + Data_Foldable.foldMap(Data_Array_NonEmpty_Internal.foldableNonEmptyArray)(Data_Monoid.monoidString)(formatBinding)(v1.value1);
              };
              return formatInstanceHead(indentation)(indent)(v.head) + Data_Foldable.foldMap(Data_Foldable.foldableMaybe)(Data_Monoid.monoidString)(formatBindings)(v.body);
          };
      };
  };
  var formatDeclaration = function (indentation) {
      return function (indent) {
          return function (declaration) {
              ...
              if (declaration instanceof PureScript_CST_Types.DeclData) {
                  var formatDataConstructors = function (v) {
                      return newline + indented + (formatSourceToken(indented)(blank)(v.value0) + formatSeparated(singleOrMultiline(PureScript_CST_Range.rangeOfDecl(PureScript_CST_Range.rangeOfVoid))(declaration))(indented)(blank)(formatDataConstructor(indentation)(indented))(v.value1));
                  };
                  return formatDataHead(indentation)(indent)(declaration.value0) + (Data_Foldable.foldMap(Data_Foldable.foldableMaybe)(Data_Monoid.monoidString)(formatDataConstructors)(declaration.value1) + newline);
              };
              if (declaration instanceof PureScript_CST_Types.DeclType) {
                  return formatDataHead(indentation)(indent)(declaration.value0) + (newline + (indented + (formatSourceToken(indented)(blank)(declaration.value1) + (space + (formatType(indentation)(indented + indentation)(singleOrMultiline(PureScript_CST_Range.rangeOfType(PureScript_CST_Range.rangeOfVoid))(declaration.value2))(declaration.value2) + newline)))));
              };
              if (declaration instanceof PureScript_CST_Types.DeclNewtype) {
                  var prefix = (function () {
                      var v = singleOrMultilineBetween(PureScript_CST_Range.rangeOfName)(PureScript_CST_Range.rangeOfType(PureScript_CST_Range.rangeOfVoid))(declaration.value2)(declaration.value3);
                      if (v instanceof MultipleLines) {
                      ...
                      throw new Error("Failed pattern match at Format (line 330, column 16 - line 332, column 28): " + [ v.constructor.name ]);
                  })();
                  return formatDataHead(indentation)(indent)(declaration.value0) + (newline + indented + (formatSourceToken(indented)(blank)(declaration.value1) + (space + (formatName(indented)(blank)(declaration.value2) + (prefix + (formatType(indentation)(indented)(lines)(declaration.value3) + newline))))));
              };
              if (declaration instanceof PureScript_CST_Types.DeclClass) {
                  var formatLabeledMember = function (labeled) {
                      return newline + (indented + formatLabeledNameType(indentation)(indented)(labeled));
                  };
                  var formatMember = function (v) {
                      return formatSourceToken(indent)(space)(v.value0) + Data_Semigroup_Foldable.intercalateMap(Data_Array_NonEmpty_Internal.foldable1NonEmptyArray)(Data_Semigroup.semigroupString)(newline + indented)(formatLabeledMember)(v.value1);
                  };
                  return formatClassHead(lines)(indentation)(indent)(declaration.value0) + (Data_Foldable.foldMap(Data_Foldable.foldableMaybe)(Data_Monoid.monoidString)(formatMember)(declaration.value1) + newline);
              };
              if (declaration instanceof PureScript_CST_Types.DeclInstanceChain) {
                  return formatSeparated(singleOrMultiline(PureScript_CST_Range.rangeOfSeparated(PureScript_CST_Range.rangeOfInstance(PureScript_CST_Range.rangeOfVoid)))(declaration.value0))(indent)(space)(formatInstance(indentation)(indent))(declaration.value0) + newline;
              };
              if (declaration instanceof PureScript_CST_Types.DeclDerive) {
                  return formatSourceToken(indent)(blank)(declaration.value0) + (Data_Foldable.foldMap(Data_Foldable.foldableMaybe)(Data_Monoid.monoidString)(formatSourceToken(indent)(space))(declaration.value1) + (space + (formatInstanceHead(indentation)(indent)(declaration.value2) + newline)));
              };
              if (declaration instanceof PureScript_CST_Types.DeclKindSignature) {
                  return formatSourceToken(indentation)(indent)(declaration.value0) + (space + formatLabeledNameType(indentation)(indent)(declaration.value1));
              };
              if (declaration instanceof PureScript_CST_Types.DeclSignature) {
                  return formatLabeledNameType(indentation)(indent)(declaration.value0);
              };
              if (declaration instanceof PureScript_CST_Types.DeclValue) {
                  return formatValueBindingFields(indentation)(indent)(declaration.value0) + newline;
              };
              if (declaration instanceof PureScript_CST_Types.DeclFixity) {
                  return formatFixityFields(indent)(declaration.value0) + newline;
              };
              if (declaration instanceof PureScript_CST_Types.DeclForeign) {
                  return formatSourceToken(indent)(blank)(declaration.value0) + (formatSourceToken(indent)(space)(declaration.value1) + (space + (formatForeign(lines)(indentation)(indent)(declaration.value2) + newline)));
              };
              if (declaration instanceof PureScript_CST_Types.DeclRole) {
                  return formatSourceToken(indentation)(indent)(declaration.value0) + (space + (formatSourceToken(indentation)(indent)(declaration.value1) + (space + (formatName(indent)(blank)(declaration.value2) + (Data_Foldable.foldMap(Data_Array_NonEmpty_Internal.foldableNonEmptyArray)(Data_Monoid.monoidString)(function (role$prime) {
                      return space + formatRole(indentation)(indent)(role$prime);
              ...
              throw new Error("Failed pattern match at Format (line 294, column 52 - line 396, column 30): " + [ declaration.constructor.name ]);
          };
      };
  };
  var formatDeclarations = function (indentation) {
      var formatOne = function (declaration) {
          return newline + formatDeclaration(indentation)(blank)(declaration);
      };
      return Data_Foldable.foldMap(Data_Foldable.foldableArray)(Data_Monoid.monoidString)(formatOne);
  };
  var formatModuleBody = function (indentation) {
      return function (v) {
          return formatDeclarations(indentation)(v.decls) + formatCommentsTrailingModule(v.trailingComments);
      };
  };
  var formatModule = function (indentation) {
      return function (v) {
          return formatModuleHeader(indentation)(v.header) + formatModuleBody(indentation)(v.body);
      };
  };
...
(function($PS) {
  ...
  var PureScript_CST_Errors = $PS["PureScript.CST.Errors"];                
  var parseAndFormat$prime = function ($25) {
      return (function (v) {
          if (v instanceof PureScript_CST.ParseSucceeded) {
              return Data_Either.Right.create(Format.format(v.value0));
          };
          if (v instanceof PureScript_CST.ParseSucceededWithErrors) {
              return Data_Either.Left.create(Data_Array_NonEmpty.foldMap1(Data_Semigroup.semigroupString)(function (v1) {
                  return PureScript_CST_Errors.printParseError(v1.error) + (" at " + Data_Show.show(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                      return "column";
                  }))(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                      return "line";
                  }))(Data_Show.showRecordFieldsNil)(Data_Show.showInt))(Data_Show.showInt)))(v1.position));
              })(v.value1));
          };
          if (v instanceof PureScript_CST.ParseFailed) {
              return new Data_Either.Left("Parse Failed");
          };
          throw new Error("Failed pattern match at Main (line 39, column 35 - line 46, column 26): " + [ v.constructor.name ]);
      })(PureScript_CST.parseModule($25));
  };
  var parseAndFormat = (function () {
      var $26 = Data_Either.either(Control_Category.identity(Control_Category.categoryFn))(Control_Category.identity(Control_Category.categoryFn));
      return function ($27) {
          return $26(parseAndFormat$prime($27));
      };
  })();
  var main = (function () {
      if ($foreign.argv.length === 0) {
          return Effect_Class_Console.error(Effect_Class.monadEffectEffect)("Please supply a file");
      };
      if ($foreign.argv.length === 1) {
          return Effect_Class_Console.error(Effect_Class.monadEffectEffect)("Please supply a file");
      };
      if ($foreign.argv.length === 2) {
          return Effect_Class_Console.error(Effect_Class.monadEffectEffect)("Please supply a file");
      };
      if ($foreign.argv.length === 3) {
          return Node_FS_Async.readTextFile(Node_Encoding.UTF8.value)($foreign["argv"][2])(function (v) {
              if (v instanceof Data_Either.Left) {
                  return Control_Monad_Error_Class.throwError(Control_Monad_Error_Class.monadThrowEffect)(v.value0);
              };
              if (v instanceof Data_Either.Right) {
                  var v1 = parseAndFormat$prime(v.value0);
                  if (v1 instanceof Data_Either.Left) {
                      return Control_Monad_Error_Class.throwError(Control_Monad_Error_Class.monadThrowEffect)(Effect_Exception.error(v1.value0));
                  };
                  if (v1 instanceof Data_Either.Right) {
                      return Effect_Class_Console.log(Effect_Class.monadEffectEffect)(v1.value0);
                  };
                  throw new Error("Failed pattern match at Main (line 30, column 11 - line 32, column 31): " + [ v1.constructor.name ]);
              };
              throw new Error("Failed pattern match at Main (line 27, column 30 - line 32, column 31): " + [ v.constructor.name ]);
          });
      };
      return Effect_Class_Console.error(Effect_Class.monadEffectEffect)("Please only supply one argument");
  })();
  exports["main"] = main;
